...
function updateStyle() {
    ...
    scaleX(horizontals[1], 0.1)
    scaleX(horizontals[2], 1)
    scaleX(horizontals[3], 0.55)
    scaleX(horizontals[4], 0.4)
    scaleX(horizontals[5], -0.05)
    scaleX(horizontals[6], 0.3)
    scaleX(horizontals[7], 0.8)
    scaleX(horizontals[8], 8)

    scaleY(verticals[0], 0.3)
    scaleY(verticals[1], 0.35)
    scaleY(verticals[2], 1.1)
    scaleY(verticals[3], 0.8) //what elem, what rate
    scaleY(verticals[4], 3)
    scaleY(verticals[5], 0.25)
    scaleY(verticals[6], 6)
